...
def predict_timber(w_length, weights_yolov5, weights_class, img_dir, path,
    ...
    w_class_list = []
    w_classes = ['1/2', 'dr', '3']  # подвиды древесины (для модели EfficientNetB0)
    for i in range(len(bboxes)):
        cropped_img = prepare_crops(img_dir, bboxes[i], os.path.join(detect_dir, 'crops'), f'{i}.png', resize_dim=(48, 48))
